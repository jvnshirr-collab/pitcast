...
(function (root) {
   ...
   *   Mod-B31G: M = √(1 + 0.6275·14.83 − 0.003375·14.83²) ≈ 3.092
   *             σ_f = (359+68.95) · (1 − 0.85·0.3559) / (1 − 0.85·0.3559/3.092)
   *                 ≈ 427.95 · 0.6975 / 0.9022 ≈ 330.9 MPa
   *             P_f ≈ 7.75 MPa = 77.5 bar;  P_safe ≈ 55.7 bar
   *   (verified by benchmark/test-b31g.js)
   * --------------------------------------------------------------------- */
