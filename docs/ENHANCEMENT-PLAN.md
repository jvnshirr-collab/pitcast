...
- [x] Use library access opportunistically; add verified cases; record source; re-run `run.js`; update coverage honestly. → **4 verified cases added via the live library hunt**: (1) 254 SMO ASTM G48 Method E CPT 65 °C (Outokumpu; on-basis, predicts 61.3 °C, Δ −3.7 °C); (2–4) **in-envelope CO₂ from 2 independent sources** — Elgaddafi 2015 (DOI 10.1016/j.jngse.2015.10.034) autoclave 80 °C, pCO₂ 4.1 & 6.2 bar, 0.32 & 0.28 mm/y; Peng 2024 (DOI 10.3390/ma17051094) L360N blank 40 °C, CO₂-saturated, 0.323 mm/y. The CO₂ in-scope corpus **doubled (3→6)** and broke the "all out-of-envelope" wall; all three in-envelope points fall below the ensemble → bulk models **over-predict real multi-day weight-loss rates 1.5–4×** (honest finding; coverage 17%). Several other CO₂ sources were figure-only/out-of-envelope (logged). Growth continues opportunistically.
